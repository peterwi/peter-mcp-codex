---
name: skill-creator
description: Create and update skills that extend the agent's capabilities. Use when building domain-specific expertise, modular workflows, or integrating specialized tools. Covers skill structure, component design (scripts/references/assets), SKILL.md creation, and progressive disclosure patterns. Follow the 6-step creation process: understand examples → plan resources → initialize → edit → package → iterate.
