 ...
 */
function parseKernelVersion(version) {
 ...
 */
async function isBccToolAvailable(tool) {
    const paths = [
...
export async function detectCapabilities() {
    ...
    const [hasPerf, hasBpftool, hasBpftrace, hasIostat, hasVmstat, hasSar, hasSs, hasNstat] = await Promise.all([
