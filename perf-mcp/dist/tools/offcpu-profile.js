...
export async function perfOffcpuProfile(input = {}) {
...
async function runBccOffcputime(params, startTime, notes) {
    const args = [
...
async function runPerfSched(params, startTime, notes) {
...
//# sourceMappingURL=offcpu-profile.js.map